...
"""
function LineSamples_interpolation(backend :: CPUComputeBackend, grid_template :: LineSamples{D, TF}, input :: ITPINPUT, catalog :: InterpolationCatalog{N, 0, 0, 0, N}, itp_strategy :: Type{ITPSTRATEGY} = itpScatter) where {D, N, TF <: AbstractFloat, ITPINPUT <: InterpolationInput{TF}, ITPSTRATEGY <: AbstractInterpolationStrategy}
...
@inline function _line_samples_interpolation_kernel!(:: CPUComputeBackend, grids::NTuple{N, LineSamples{3, TF}}, i::Int, input::ITPINPUT, catalog_consice::InterpolationCatalogConcise{N, 0, 0, 0}, LBVH::LinearBVH, ::Type{itpScatter}) where {N, TF <: AbstractFloat, ITPINPUT <: InterpolationInput{TF}}
